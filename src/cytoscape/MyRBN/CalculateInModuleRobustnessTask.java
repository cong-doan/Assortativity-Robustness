 ...
 * @author Le Duc Hau
 */
public class CalculateInModuleRobustnessTask  implements Task{
    ...
    /**/
    public CalculateInModuleRobustnessTask() {
        this.error = false;
        this.errMsgs = "";
    ...
    public CalculateInModuleRobustnessTask(int PerturbationType, boolean radCurrentState, boolean radAllPossibleState, String txtNumOfRandomStates) {
...
//                            }
                ...
                if(MyOpenCL.OPENCL_PLATFORM == MyOpenCL.GPU_PLATFORM)
                {
                    ...
                    noRobustStates_new = MyRBN.myopencl.calInModuleRobustness_NestedCanalyzing(MyRBN.nodes, posSelectedNodes, allStates, PerturbationType, NumPossibleFunc, 1000, MyRBN.NumberOfCluster);
                    System.out.println("inmodulerobustness");
                ...
                double robustinmodule=0,r_inmodule=0;
                int size=0;
                for(i=0;i<MyRBN.NumberOfCluster;i++)
                {
                    ...
                    r_inmodule=r_inmodule/size;       
                  robustinmodule=robustinmodule+r_inmodule;
                    
                }
                robustinmodule=robustinmodule/MyRBN.NumberOfCluster;  
                System.out.println("robustinmodule:"+robustinmodule);
                MyRBN.inmodulerobustness=robustinmodule;
